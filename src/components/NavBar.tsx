...
export default function NavBar({bgClass, altBgClass}: NavBarProps) {
  return (
    <div className={`w-15/16 h-11 sm:h-16 md:h-20 lg:h-22 ${bgClass} rounded-[40px] mx-auto pl-12 pr-12 relative top-4 flex items-center justify-between shadow-[8px_10px_0_0] ${altBgClass} transition-colors duration-300 ease-in-out`}>
